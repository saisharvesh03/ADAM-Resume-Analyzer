...
st.set_page_config(
    page_title="ADAM Resume Analyzer",
    page_icon='./Logo/images/lodoADAM.png',
)


def run():
    icon_image = Image.open("././Logo/images/logo432.png")
    st.title("ADAM Resume Analyser")
    st.sidebar.markdown("# Choose User")
    activities = ["Normal User"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    # link = '[©Developed by Spidy20](http://github.com/spidy20)'
    # st.sidebar.markdown(link, unsafe_allow_html=True)
    img = Image.open('./Logo/images/logo432.png')
    img = img.resize((750, 250))
    st.image(img)
